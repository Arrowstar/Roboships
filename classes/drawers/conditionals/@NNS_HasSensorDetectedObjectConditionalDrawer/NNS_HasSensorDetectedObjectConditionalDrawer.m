classdef NNS_HasSensorDetectedObjectConditionalDrawer < NNS_AbstractControllerCommandDrawer
    ...
    methods
        function obj = NNS_HasSensorDetectedObjectConditionalDrawer(cmd)
            obj.cmd = cmd;
