classdef NNS_BasicTurretedGunFireGunCntrlrOperationDrawer < NNS_AbstractControllerCommandDrawer
    ...
    methods
        function obj = NNS_BasicTurretedGunFireGunCntrlrOperationDrawer(cmd)
            obj.cmd = cmd;
        end
