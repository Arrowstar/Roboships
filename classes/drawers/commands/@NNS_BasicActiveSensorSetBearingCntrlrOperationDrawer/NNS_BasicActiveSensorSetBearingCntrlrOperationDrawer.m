classdef NNS_BasicActiveSensorSetBearingCntrlrOperationDrawer < NNS_AbstractControllerCommandDrawer
    ...
    methods
        function obj = NNS_BasicActiveSensorSetBearingCntrlrOperationDrawer(cmd)
            obj.cmd = cmd;
        end
